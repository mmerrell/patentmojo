...
public class PatentMojoPresentationLayerInfo extends PresentationLayerInfo
        implements IPresentationLayerInfo {
    ...
    // putting the files in src/test/generated/com... would not be part of the
    // "maven convention". The question is, can I put it
    ...
    private static final String GENERATED_PAGE_FIELDS_PATH = "src/test/java/com/tastymonster/automation/director/user/";
    private static final String GENERATED_TEST_PAGE_PATH = "src/test/java/com/tastymonster/automation/user/";
    ...
    @Override
    public String getGeneratedPageFieldsPath() {
        return GENERATED_PAGE_FIELDS_PATH;
    }
